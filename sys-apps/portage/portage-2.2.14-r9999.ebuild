...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.2.14-r9999.ebuild,v 1.10 2015/03/02 09:27:01 ago Exp $
...
TARBALL_PV=${PV}
SRC_URI="http://lipsum.eu/${PN}-${TARBALL_PV}-r9999.tar.bz2"
